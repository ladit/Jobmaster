...
class NeituiSpider(Spider):
    ...
    def parse_job(self, response):
        ...
        item['job_min_edu'] = response.xpath('//div[@class="font16 mt10 mb10"]/span/text()').extract()[2]
        item['job_workplace'] = response.xpath('//div[@class="font16 mt10 mb10"]/span/text()').extract()[3]
